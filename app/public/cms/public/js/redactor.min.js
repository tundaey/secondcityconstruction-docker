...
(function($){
	...
	var Redactor = function(element, options)
	{
		...
		this.opts = $.extend({
			...
			colors: [
			    '#0000FF', '#6600FF', '#FF0000', '#FF6600', '#66FF00', 
	...
	Redactor.prototype = {
		...
		imageEdit: function(e)
		{
			...
			var callback = $.proxy(function()
			{
				...
				$('#redactorSaveBtn').click($.proxy(function() { this.imageSave($el,img); }, this));
		...
		imageSave: function(el,img)
		{
			...
			// as link
			var link = $(".redactor_input").val(); 
			
			$( ".redactor_input" ).each(function( index ) {
				  console.log( index + ": " + $( this ).val() );
				  if ($( this ).val() !== '')
					{
						if ($(parent).get(0).tagName !== 'A')
						{
							$(el).replaceWith('<a href="' + $( this ).val() + '">' + img.outerHTML + '</a>');
						}
						else
						{
							$(parent).attr('href', $( this ).val());
						}
					}
					else
					{
		...
		{	//redactor_link_blank
			...
			if (tab_selected === '1') // url
			{
				...
				*/
				if($('input#redactor_link_blank:checked').length) {
					target = ' target="_blank"';
				}
				// test url
